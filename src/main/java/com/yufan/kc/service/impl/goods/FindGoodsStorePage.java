 ...
 * 功能介绍:
 */
@Service("kc_page_goods_store")
public class FindGoodsStorePage implements IResultOut {

    private Logger LOG = Logger.getLogger(FindGoodsStorePage.class);
    ...
    public String getResult(ReceiveJsonBean receiveJsonBean) {
        ...
        try {
            ...
            PageInfo page = goodsDao.loadStoreGoodsPage(conditionCommon);
            dataJson.put("goods_store_list", page.getResultListMap());
